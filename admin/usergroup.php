...
<script>
    layui.config({
        ...
        table.render({
            ...
            ,url: '../interface/ajax.php?t=admin&a=usergroup-json'
            ...
            ,cols: [[
                ...
                ,{field:'data', title:'自定义数据', minWidth:400}
            ...
            switch(obj.event){
                    ...
                    layer.open({
                        ...
                        ,yes: function(index, layero){
                            ...
                            iframeWindow.layui.form.on('submit(LAY-user-front-submit)', function(datas){
                                ...
                                $.ajax({
                                    type:'POST',
                                    url:'../interface/ajax.php?t=admin&a=usergroup-set',
                                    dataType: 'json',
                                    data: field,
                                    cache: false,
                ...
                case 'del':
                    ...
                    layer.confirm('确认删除选中用户组吗？',{title:'二次确认'}, function(index){
                        $.ajax({
                            type:'POST',
                            url:'../interface/ajax.php?t=admin&a=usergroup-delor',
                            dataType: 'json',
        ...
        table.on('tool(test-table-toolbar)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('确认删除用户组['+data.name+']吗？', function(index){
                    $.ajax({
                        type:'POST',
                        url:'../interface/ajax.php?t=admin&a=usergroup-del&id='+data.id,
                        dataType: 'json',
                        data: '',
                        cache: false,
                        success: function (data) {
                ...
                layer.open({
                    ...
                    ,type: 2
                    ,content: 'usergroupinfo.php?id='+data.id
                    ,shadeClose: true
                    ,area: admin.screen() < 2 ? ['100%', '100%'] : ['695px', '80%']
                    ,btn: ['确定', '取消']
                    ,maxmin: true
                    ,yes: function(index, layero){
                        ...
                        iframeWindow.layui.form.on('submit(LAY-user-front-submit)', function(datas){
                            ...
                            $.ajax({
                                type:'POST',
                                url:'../interface/ajax.php?t=admin&a=usergroup-set&id='+data.id,
                                dataType: 'json',
                                data: field,
                                cache: false,
                                success: function (data) {
