...
<body>
        ...
        <form class="layui-form layui-form-pane" lay-filter="layuiadmin-form-admin">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="notice_title" lay-verify="text" placeholder="请填写公告标题" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">公告内容</label>
                <div class="layui-input-block">
                    <textarea type="text" id="notice_info" name="notice_info" placeholder="请填写公告详细内容" autocomplete="off" class="layui-textarea" style="height:100px;"></textarea>
                </div>
            </div>
  ...
  layui.config({
    ...
    if (idd != null) {
        $.ajax({
            type:'GET',
            url:'../interface/ajax.php?t=admin&a=notice-get&id=' + idd,
            dataType: 'json',
            cache: false,
            success: function (data) {
