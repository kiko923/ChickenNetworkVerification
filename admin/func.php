...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-header">云端计算(登录可用)</div>
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form layui-form-pane" action="" lay-filter="layuiadmin-form-admin">
                <div class="layui-form-item">
                    <blockquote class="layui-elem-quote">此处写的函数为 [<b><span style="color:green">需要登录</span></b>] 才可调用使用的动态函数。</blockquote>
                </div>
...
<script>
    layui.config({
        ...
        $.ajax({
            url: '../interface/ajax.php?t=admin&a=get-func',
            type: 'GET',
            dataType: 'text',
            async: false,
        ...
        form.on('submit(submitA)', function(data){
            ...
            $.ajax({
                url: '../interface/ajax.php?t=admin&a=set-func',
                type: 'POST',
                dataType: 'json',
                data: txt,
                success: function (res) {
