    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">黑名单表</div>
...
<script>
    layui.config({
        ...
        table.render({
            ...
            ,url: '../interface/ajax.php?t=admin&a=black-json&id='+idd
            ...
            ,cols: [[
                ...
                ,{field:'data', title:'云黑数据',minWidth:300}
        ...
        table.on('toolbar(test-table-toolbar)', function(obj){
            ...
            switch(obj.event){
                    ...
                    layer.open({
                        ...
                        ,yes: function(index, layero){
                            ...
                            iframeWindow.layui.form.on('submit(LAY-user-front-submit)', function(datas){
                                ...
                                $.ajax({
                                    type:'POST',
                                    url:'../interface/ajax.php?t=admin&a=black-set',
                                    dataType: 'json',
                                    data: field,
                                    cache: false,
                ...
                case 'del':
                    ...
                    layer.confirm('确认删除选中数据吗？',{title:'二次确认'}, function(index){
                        $.ajax({
                            type:'POST',
                            url:'../interface/ajax.php?t=admin&a=black-delor',
                            dataType: 'json',
        ...
        table.on('tool(test-table-toolbar)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('确认删除选中数据吗？',{title:'二次确认'}, function(index){
                    $.ajax({
                        type:'POST',
                        url:'../interface/ajax.php?t=admin&a=black-del&id='+data.id,
                        dataType: 'json',
                        data: '',
                        cache: false,
                        success: function (data) {
                ...
                layer.open({
                    title:'修改数据[id:'+data.id+']'
                    ,type: 2
                    ,content: 'blackinfo.php?id='+data.id
                    ,shadeClose: true
                    ,area: admin.screen() < 2 ? ['100%', '100%'] : ['695px', '80%']
                    ,btn: ['确定', '取消']
                    ,maxmin: true
                    ,yes: function(index, layero){
                        ...
                        iframeWindow.layui.form.on('submit(LAY-user-front-submit)', function(datas){
                            ...
                            $.ajax({
                                type:'POST',
                                url:'../interface/ajax.php?t=admin&a=black-set&id='+data.id,
                                dataType: 'json',
                                data: field,
                                cache: false,
                                success: function (data) {
