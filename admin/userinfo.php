...
<body>
    <div class="layui-card-body" style="margin: 5px;">
        <form class="layui-form layui-form-pane" lay-filter="layuiadmin-form-admin">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">绑定组别</label>
                <div class="layui-input-block">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="endtime" id="endtime" placeholder="请选择到期时间" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">点数余额</label>
                <div class="layui-input-block">
                    <input type="number" name="point" placeholder="可留空" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">积分余额</label>
                <div class="layui-input-block">
                    <input type="number" name="integral" placeholder="可留空" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="dk" placeholder="多开数量(可留空)" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="agent" placeholder="请输入代理账号(可留空)" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
  ...
  layui.config({
    ...
    if (idd != null) {
        ...
        $.ajax({
            type:'GET',
            url:'../interface/ajax.php?t=admin&a=user-get&id=' + idd,
            dataType: 'json',
            cache: false,
            success: function (data) {
