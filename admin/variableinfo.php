...
<body>
  ...
  layui.config({
    ...
    if (idd != null) {
        $.ajax({
            type:'GET',
            url:'../interface/ajax.php?t=admin&a=variable-get&id=' + idd,
            dataType: 'json',
            cache: false,
            success: function (data) {
